...
export_fig('latex/figs/ex4_a', '-pdf', '-painters', '-transparent');

mh12.plot(cB, 'view', [60 30], 'zoom', 1.4, 'floorlevel', -l0-0.5, 'noname', 'notiles');
export_fig('latex/figs/ex4_b', '-pdf', '-painters', '-transparent');

mh12.plot(cC, 'view', [60 30], 'zoom', 1.4, 'floorlevel', -l0-0.5, 'noname', 'notiles');
export_fig('latex/figs/ex4_c', '-pdf', '-painters', '-transparent');